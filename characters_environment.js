...
{
  GameStatus = "start";
  document.getElementById("status").innerHTML = "El unijuego está unicargando";
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    text("Presiona el unibotón UniJugar para uniniciar el unijuego", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Fin del unijuego", gameConfig.screenX/2, gameConfig.screenY/2+105);
    textSize(15);
    text("Presiona la unibarra espaciadora para unireiniciar", gameConfig.screenX/2, gameConfig.screenY/2+135);
    textSize(40);
...
//deben cumplirse las 3 condiciones, tecla jugar presionada, estatus de carga y deteccion de nariz
 ...
 { 
   document.getElementById("status").innerHTML = "El unijuego se ha unicargado";
